...
<ComponentStructure title="Router" url="router" {jsonData}>
	...
	<div slot="more">
		<div class="container mx-auto p-4">
			<h1
				class="text-4xl font-bold text-center text-gradient bg-gradient-to-r from-blue-500 to-purple-600"
			>
				Route Coordinates
			</h1>
			...
			<div class="my-10">
				<h1
					class="text-4xl font-bold text-center text-gradient bg-gradient-to-bl from-green-500 to-blue-600"
				>
					Summary
				</h1>
			...
			<div class="my-10">
				<h1
					class="text-4xl font-bold text-center text-gradient bg-gradient-to-bl from-pink-500 to-orange-500"
				>
					Route (First 10)
				</h1>
				<div
			...
			<div class="my-10">
				<h1
					class="text-4xl font-bold text-center text-gradient bg-gradient-to-r from-purple-500 to-pink-500"
				>
